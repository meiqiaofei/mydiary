...
public class DiaryAdapter extends ArrayAdapter<Diary> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 有可能上次是点布局而这次是日记布局
        // 也有可能上次是日记布局而这次是点布局
        if (convertView == null || convertView.getId() == R.id.activity_main_listview_diary_layout
                && diary.getContent().equals("") || convertView.getId() == R.id.activity_main_listview_point_layout
